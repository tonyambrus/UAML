...
namespace Microsoft.MixedReality.Toolkit.Input
{
    ...
    public class EyeTrackingTarget : InputSystemGlobalHandlerListener, IMixedRealityPointerHandler, IMixedRealitySpeechHandler
    {
        ...
        [SerializeField]
        private UnityEvent onTapDown = null;
        ...
        [SerializeField]
        private UnityEvent onTapUp = null;
        ...
        private void Update()
        {
            ...
            if ((CoreServices.InputSystem != null) && (CoreServices.InputSystem.EyeGazeProvider != null) &&
                CoreServices.InputSystem.EyeGazeProvider.UseEyeTracking &&
        ...
        float minTimeoutBetweenClicksInMs = 20f;
        ...
        {
            Debug.Log($"EyeTrackingTarget -> RaiseSelectEventManually [{this.name}]");
            EyeTrackingTarget.SelectedTarget = this.gameObject;
            OnSelected.Invoke();
        }
        ...
        {
            Debug.Log($"EyeTrackingTarget -> RaiseEventManually_TapDown [{this.name}]");
            OnTapDown.Invoke();
        }

        public void RaiseEventManually_TapUp()
        {
            Debug.Log($"EyeTrackingTarget -> RaiseEventManually_TapUp [{this.name}]");
            OnTapUp.Invoke();
        }
    }
}