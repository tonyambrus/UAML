...
namespace Microsoft.MixedReality.Toolkit.WindowsMixedReality.Input
{
    ...
    public class WindowsMixedRealityEyeGazeDataProvider : BaseInputDeviceManager, IMixedRealityEyeGazeDataProvider, IMixedRealityEyeSaccadeProvider, IMixedRealityCapabilityCheck
    {
        ...
        private int confidenceOfSaccadeThreshold = 1; // TODO(https://github.com/Microsoft/MixedRealityToolkit-Unity/issues/3767): This value should be adjusted based on the FPS of the ET system
        ...
        public override void Update()
        {
            ...
            if (pointerPose != null)
            {
                ...
                if (eyes != null)
                {
                    ...
                    CoreServices.InputSystem?.EyeGazeProvider?.UpdateEyeTrackingStatus(this, eyes.IsCalibrationValid);

                    if ((eyes.Gaze.HasValue) && (eyes.Gaze.Value.Origin != System.Numerics.Vector3.Zero))
                    {
                        ...
                        CoreServices.InputSystem?.EyeGazeProvider?.UpdateEyeGaze(this, newGaze, eyes.UpdateTimestamp.TargetTime.UtcDateTime);
                    }
                }
            }
#endif // (UNITY_WSA && DOTNETWINRT_PRESENT) || WINDOWS_UWP
