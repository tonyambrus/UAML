...
namespace Microsoft.MixedReality.Toolkit.Input
{
        ...
        IMixedRealityInputHandler
    {
        ...
        public bool allowForManualOverwrite = false;
        ...
        public InternalGazePointer gazePointer = null;
        ...
        /// <inheritdoc />
        public bool IsEyeGazeValid => IsEyeTrackingAvailable;
        ...
        public class InternalGazePointer : GenericPointer
        {
            ...
            #region Test for custom cursor pointers: Uncomment the following lines and remove 'ManualGazePointerUpdate' to revert
            /// <inheritdoc />
            public override void OnPreSceneQuery()
            {
                if (!gazeProvider.allowForManualOverwrite)
                {
            ...
            public void ManualGazePointerUpdate(Vector3 newGazeOrigin, Vector3 endPoint)
            {
                if (gazeProvider.allowForManualOverwrite)
                {
                    Rays[0].UpdateRayStep(ref newGazeOrigin, ref endPoint);
                    RaycastHit hitInfo;
                    UnityEngine.Physics.Raycast(Rays[0], out hitInfo);
                    gazeProvider.HitPosition = hitInfo.point;                    
                }
            }
            #endregion
        ...
        public Ray EyeGazeRay { get; private set; }
        ...
        public void UpdateEyeGaze(IMixedRealityEyeGazeDataProvider provider, Ray eyeRay, DateTime timestamp)
        {
            ...
            EyeGazeRay = new Ray(latestEyeGaze.origin, latestEyeGaze.direction);
        }
