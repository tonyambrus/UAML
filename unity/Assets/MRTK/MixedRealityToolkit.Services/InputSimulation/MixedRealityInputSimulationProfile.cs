...
namespace Microsoft.MixedReality.Toolkit.Input
{
    ...
    public class MixedRealityInputSimulationProfile : BaseMixedRealityProfile
    {
        ...
        [SerializeField]
        [Tooltip("By default the eye gaze is controlled via the camera movement.")]
        private bool simulateEyeGazeWithMouse = false;
        ...
        /// <summary>
        /// If true: Control eye gaze via mouse. If false: Control it via the camera (as with head gaze).
        /// </summary>
        public bool SimulateEyeGazeWithMouse => simulateEyeGazeWithMouse;
